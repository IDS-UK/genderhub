...
<div class="section group main_content">
    ...
    <div class="col span_3_of_4 archive_content padding10">
        ...
        <?php while ( have_posts() ) : the_post(); ?>
            ...
            <?php get_template_part( 'content', 'programme_alerts' ); ?>
            ...
            <!--<nav class="nav-single">
                    ...
                    <span class="nav-next"><?php next_post_smart( '%link', '<span class="meta-nav">' . _x( '<img class="prev_next_arrows" alt="Previous Post" src="http://genderhub.org/wp-content/themes/genderhub/images/arrowR.png" /><br />', 'Next post link', 'twentythirteen' ) . '</span> %title' ); ?></span>
            </nav><!-- .nav-single -->
