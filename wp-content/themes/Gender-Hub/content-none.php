...
<header class="page-header">
	<h2 class="page-title"><?php _e( 'Nothing found for that search', 'twentythirteen' ); ?></h2>
</header>
...
<div class="page-content">
	...
	<br /><br />Try searching just one of them or please try again with different keywords.', 'twentythirteen' ); ?><br /><br /></p>
	<?php get_search_form(); ?>
