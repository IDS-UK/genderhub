...
<header class="archive-header">
				<h1 class="archive-title"><span><?php
					if ( is_day() ) :
            ...
            single_cat_title( '', true );
					elseif ( is_post_type_archive( 'ids_documents' ) ) :
						...
						_e( 'Searched archives', 'twentythirteen' );
					endif;
				?></span></h1>
			</header><!-- .archive-header -->


<span class="count-items"><?php global $wp_query; echo $wp_query->found_posts; ?> post(s) for this section</span>
