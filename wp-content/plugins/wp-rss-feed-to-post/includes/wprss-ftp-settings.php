	...
	public function register_settings() {
		...
		*/
		...
		add_settings_field( 
			...
			__( "", 'wprss' ),									// The label to the left of the option element
...
#== SETTINGS VALIDATOR =================================================================================	
	...
	public function validate_settings( $input ) {
		...
		if ( ! empty( $_POST[ $prefix.'post_taxonomy' ] ) ) {
			...
			$terms = $_POST[ $prefix.'post_terms' ];
			$autos = $_POST[ $prefix.'auto_terms' ];
		...
		<span class="wprss-ftp-authors-hide-if-using-existing">
			...
			<?php
				if ( class_exists( 'WPRSS_Help' ) ) {
					echo WPRSS_Help::get_instance()->do_tooltip( WPRSS_FTP_HELP_PREFIX.'fallback_author' );
				}
			?>
		</span>
