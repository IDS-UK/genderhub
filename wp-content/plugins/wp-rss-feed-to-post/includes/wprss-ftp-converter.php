			...
			// Author found
				...
				// Author has no user on site
					...
					if ( $author_fallback_method === 'create' ) {
						...
						WPRSS_FTP_Utils::log_object( 'User not found in system. Attempted to create', $new_user_id, __FUNCTION__, WPRSS_FTP_Utils::LOG_LEVEL_SYSTEM);
						if( !$new_user_id )
							WPRSS_FTP_Utils::log_object( 'User could not be created.', $author_email, __FUNCTION__, WPRSS_FTP_Utils::LOG_LEVEL_NOTICE);
					}
