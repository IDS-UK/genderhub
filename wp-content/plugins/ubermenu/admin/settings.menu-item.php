	...
	<div class="ubermenu-menu-item-settings-wrapper">
		...
		<div class="ubermenu-menu-item-panel ubermenu-menu-item-panel-negative">
			...
			<div class="ubermenu-menu-item-stats shift-clearfix">
				<div class="ubermenu-menu-item-title">Menu Item Florgenstein</div>
		...
		'ops'		=> array(
						'group1' => array(
							...
							'enabled'=>	array(
								...
								'desc'	=> __( 'Enable the advanced submenu functionality.  This allows you to add Row menu items to the submenu.' , 'ubermenu' ),
							),
						),
					),
	);
