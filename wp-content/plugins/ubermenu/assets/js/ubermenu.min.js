...
d(this).outerHeight()>b&&(b=d(this).outerHeight());d(this).removeClass("ubermenu-test-dimensions")});var e=d(this).find("> .ubermenu-tabs-group");c?d(this).css("min-height",b+e.outerHeight()):(e.outerHeight()>b&&(b=d(this).outerHeight()),e.css("min-height",b));a?(d(this).closest(".ubermenu-submenu-drop").css("min-height",b),g.css("min-height",!1)):(d(this).closest(".ubermenu-submenu-drop").css("min-height",!1),g.css("min-height",b));f.removeClass("ubermenu-test-dimensions")})},initializeSegmentCurrentStates:function(){   var n = this.$ubermenu.find( '.ubermenu-current-menu-item' ).first().parents( '.ubermenu-item' ); if(!n.hasClass('ny_hide')){n.addClass( 'ubermenu-current-menu-ancestor' );}},
