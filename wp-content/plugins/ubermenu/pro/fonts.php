...
function ubermenu_get_menu_style_google_font( $field , $menu_id , &$menu_styles ){
	...
	if( $font_id ){
		...
		$selector = ".ubermenu-$menu_id, .ubermenu-$menu_id .ubermenu-target, .ubermenu-$menu_id .ubermenu-nav .ubermenu-item-level-0 .ubermenu-target, .ubermenu-$menu_id div, .ubermenu-$menu_id p, .ubermenu-$menu_id span,  .ubermenu-$menu_id input";
