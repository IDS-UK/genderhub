<?php
	...
	function wprss_kf_add_meta_boxes(){
		add_meta_box(
            ...
            __( 'Feed Keyword Filtering', 'wprss' ), 
	...
	function wprss_kf_meta_box_callback() {
		...
		<div class="wprss_kf_metabox_section">
			<div>
				<label for="wprss_keywords">Contains <b>all</b> of these words/phrases:</label>
			...
			<div>
				<label for="wprss_keywords_any">Contains <b>any</b> of these words/phrases:</label>
			...
			<div>
				<label for="wprss_keywords_not">Contains <b>none</b> of these words/phrases:</label>
			...
			<div>
				<label>Apply the above filtering methods on the:</label>
				...
				<label for="wprss_filter_title">Feed Title</label>
				<br/>
				...
				<label for="wprss_filter_content">Feed Content</label>
				<br/>
			</div>
		</div>
		...
		<div class="wprss_kf_metabox_section">
			<div>
				<label for="wprss_keywords_tags">Contains <b>any</b> of these tags:</label>
				<input type="text" id="wprss_keywords_tags" name="wprss_keywords_tags" value="<?php echo esc_attr($keywords_tags); ?>" placeholder="Enter a comma separated list of tags" size="60" />
			</div>
			<div>
				<label for="wprss_keywords_not_tags">Contains <b>none</b> of these tags:</label>
				<input type="text" id="wprss_keywords_not_tags" name="wprss_keywords_not_tags" value="<?php echo esc_attr($keywords_not_tags); ?>" placeholder="Enter a comma separated list of tags" size="60" />
			</div>
		</div>
