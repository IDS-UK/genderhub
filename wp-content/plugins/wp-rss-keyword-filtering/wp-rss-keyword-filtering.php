<?php
    ...
    */
    ...
    if( !defined( 'WPRSS_KF_VERSION' ) )
        define( 'WPRSS_KF_VERSION', '1.5.1', true );
	...
	if ( version_compare(WPRSS_VERSION, '4.5', '>=') ) {
		add_filter('wprss_register_addon', 'wprss_kf_register_addon');
	}
	/**
	 * Registers the Keyword Filtering add-on in the core.
	 *
	 * @since 1.5.1
	 * @param array $addons The currently registered addons
	 * @return array The registered addons, now also including the Keyword Filtering add-on
	 */
	function wprss_kf_register_addon( $addons ) {
