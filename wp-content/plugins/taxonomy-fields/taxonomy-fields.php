<?php
/*
Plugin Name: Attributi	on Tax meta class
...
if (is_admin()){
   ...
   */
  $config = array(
    'id' => 'attribution_meta_box',          // meta box id, unique per meta box
    'title' => 'Attribution Meta Box',          // meta box title
    'pages' => array('attribution'),        // taxonomy name, accept categories, post_tag and custom taxonomies
...
*/
$my_meta->addText($prefix.'attribution_text_field_id',array('name'=> __('Attribution text','tax-meta'),'desc' => 'e.g. "Sourced from:"'));
$my_meta->addImage($prefix.'attribution_image_field_id',array('image'=> __('Image ','tax-meta')));
$my_meta->addText($prefix.'display_name_field_id',array('name'=> __('Display name','tax-meta'),'desc' => 'The name of the source as displayed to visitors'));
$my_meta->addText($prefix.'website_link_field_id',array('name'=> __('Website link','tax-meta'),'desc' => 'The URL of the page to link to. Include http:// '));
