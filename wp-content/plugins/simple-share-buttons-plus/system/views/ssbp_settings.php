...
function ssbp_admin_panel()
{
    ...
    $ssbp_settings = get_ssbp_settings();
        ...
        // opening form tag
        $htmlShareButtonsForm .= $ssbpForm->open(true);
    ...
    if ($strSelectedssbp != '') {
        ...
        if ($arrSelectedssbp != '') {
            ...
            foreach ($arrSelectedssbp as $strSelected) {
                ...
                $htmlSelectedList .= '<li class="ssbp-option-item" id="'.$strSelected.'"><a href="javascript:;" class="ssbp-btn ssbp-'.$strSelected.'"><span class="ssbp-text">'.$arrButtons[$strSelected]['full_name'].'</span></a></li>';
            }
        }
    }
...
function getAvailablessbp($strSelectedssbp)
{
    ...
    if ($arrSelectedssbp != '') {
        ...
        foreach ($arrAvailablessbp as $strAvailable) {
            ...
            $htmlAvailableList .= '<li class="ssbp-option-item" id="'.$strAvailable.'"><a href="javascript:;" class="ssbp-btn ssbp-'.$strAvailable.'"><span class="ssbp-text">'.$arrButtons[$strAvailable]['full_name'].'</span></a></li>';
        }
    }
