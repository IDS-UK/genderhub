...
function ssbp_licensing()
{
    ...
    if (false !== $license && $license != '') {
		...
		<div class="form-group">
			<label for="ssbp_license_activate" class="control-label" data-toggle="tooltip" data-placement="right" data-original-title="Activate your license here">Activate License</label>
