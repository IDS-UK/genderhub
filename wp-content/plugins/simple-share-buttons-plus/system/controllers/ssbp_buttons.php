...
defined('ABSPATH') or die('No direct access permitted');
    ...
    function ssbp_show_share_buttons($content, $booShortCode = false, $atts = '')
    {
        ...
        if ((!is_home() && !is_front_page() && is_page() && $ssbp_settings['pages'] == 'Y') || (is_single() && $ssbp_settings['posts'] == 'Y') || (is_category() && $ssbp_settings['cats_archs'] == 'Y') || (is_archive() && $ssbp_settings['cats_archs'] == 'Y') || ((is_home() || is_front_page()) && $ssbp_settings['homepage'] == 'Y') || $booShortCode == true || is_search()) {
            // get license status
            ...
            // get wrap
            $wrap = '<div class="ssbp-set--one ssbp--state-hidden ssbp-wrap ssbp--'.$ssbp_settings['set_one_position'].' ssbp--theme-'.$ssbp_settings['default_style'].'"'.($ssbp_settings['one_share_counts'] == 'Y' ? ' data-ssbp-counts="true"' : null).($ssbp_settings['one_total_share_counts'] == 'Y' ? ' data-ssbp-total-counts="true"' : null).($ssbp_settings['one_toggle'] == 'Y' ? ' data-ssbp-toggle="true"' : null).($ssbp_settings['one_responsive'] == 'Y' ? ' data-ssbp-responsive="true"' : null).'>';
                ...
                $innards .= '<div class="ssbp-container" data-ssbp-share-text="'.$strShareText.'" data-ssbp-url="'.$urlCurrentPage.'" data-ssbp-title="'.$strPageTitle.'" data-ssbp-short-url="'.$urlShortened.'" data-ssbp-post-id="'.$post->ID.'">';
                    ...
                    if ($ssbp_settings['lazy_load'] != 'Y') {
                        ...
                        // the buttons!
                        $innards .= $ssbpButtons->get_ssbp_buttons($urlCurrentPage, $strPageTitle, $strShareText, $urlShortened, $post->ID);
            ...
            if ($ssbp_settings['two_style'] != '') {
                // open wrap
                $wrap .= '<div class="ssbp-set--two ssbp--state-hidden ssbp-wrap ssbp--'.$ssbp_settings['set_two_position'].' ssbp--theme-'.$ssbp_settings['two_style'].'"'.($ssbp_settings['two_total_share_counts'] == 'Y' ? ' data-ssbp-counts="true"' : null).($ssbp_settings['one_total_share_counts'] == 'Y' ? ' data-ssbp-total-counts="true"' : null).($ssbp_settings['two_toggle'] == 'Y' ? ' data-ssbp-toggle="true"' : null).'>';
