...
//======================================================================
    ...
    add_filter('the_content', 'ssbp_show_share_buttons', (int) $ssbp_settings['ssbp_content_priority']);
    ...
    if ($ssbp_settings['ga_tracking_id'] != '') {
        ...
        // ssbp admin area hook
        add_action('plugins_loaded', function() use ($ssbp_settings) {
