...
class WDTIViewTwitter_integration{
 ...
 <form class="wrap" method="post" id="spider_twitt__form" action="admin.php?page=twitter_integration" style="width:95%;">
     <div style="float:right;">
       ...
       <div class="wdti_type_div_conteiner">
         <div class="wdti_type_div_content">
           ...
           <div class="wdti_type_span" onclick="spider_twitt_change_type('timeline')" style="right:6px" >
   ...
   <table id="wdti_admintable" class="wdti_admintable">
     <tr class="wdti_tr" id="timeline_type">
	   <td class="wdti_td">
		 <label class="wdti_label">Timeline source:<span style="cursor:pointer;color:#3B5998"  class="wdti_tooltip" title="You can embed a timeline for Tweets from an individual user, a user's favorites, Twitter lists, or any search query or hashtag."> [?]</span></label>
	   </td>
	   <td>					              
         <input type="radio" class="wdti_checkbox" <?php if($row->timeline_type=='user') echo  'checked="checked"' ?> value="user"  name="timeline_type" id="timeline_type_1"  onchange="spider_twitt_change_timeline('user')"/>
         <label class="wdti_label_rad wdti_label_check" for="timeline_type_1">User timeline</label>
		 <input type="radio" class="wdti_checkbox" <?php if($row->timeline_type=='fav')  echo  'checked="checked"' ?> value="fav"  name="timeline_type" id="timeline_type_2"  onchange="spider_twitt_change_timeline('fav')"/>
         <label class="wdti_label_rad wdti_label_check" for="timeline_type_2">Favorites</label>
	     <input type="radio" class="wdti_checkbox" <?php if($row->timeline_type=='list')  echo  'checked="checked"' ?> value="list"  name="timeline_type" id="timeline_type_3"  onchange="spider_twitt_change_timeline('list')"/>
		 <label class="wdti_label_rad wdti_label_check" for="timeline_type_3">List</label>
		 <input type="radio" class="wdti_checkbox" <?php if($row->timeline_type=='search')  echo  'checked="checked"' ?> value="search"  name="timeline_type"  id="timeline_type_4"  onchange="spider_twitt_change_timeline('search')"/>
		 <label class="wdti_label_rad wdti_label_check" for="timeline_type_4">Search</label>
	   </td>
	 </tr>
	 ...
	 <tr class="wdti_tr" id="widget_id">
       <td class="wdti_td">
         <label class="wdti_label" for="widget_id_for">Widget ID: <span style="cursor:pointer;color:#3B5998"  class="wdti_tooltip" title="To get your widget ID please visit widget settings page, click on edit button for the specified widget and copy the number code in URL."> [?]</span></label>
       </td>
       <td>
          <input class="wdti_input" type="text" name="widget_id" id="widget_id_for" size="40"  value="<?php echo $row->widget_id; ?>" onkeypress="return spider_check_isnum(event)"/>
       </td>
     </tr>
	 ...
	 <tr class="wdti_tr" id="height">
       <td class="wdti_td">
         <label class="wdti_label" for="height_for">Height:<span style="cursor:pointer;color:#3B5998"  class="wdti_tooltip" title="Define the height of the social plugin in pixels"> [?]</span></label>
       </td>
       <td>
         <input class="wdti_input" type="text" name="height" id="height_for" size="40"  value="<?php echo $row->height; ?>" onkeypress="return spider_check_isnum(event)"/>
       </td>
     </tr>	 
	 <tr class="wdti_tr" id="tweet_limit">
       <td class="wdti_td">
	     <label class="wdti_label" for="tweet_limit_for">Tweet limit: <span style="cursor:pointer;color:#3B5998"  class="wdti_tooltip" title="You can choose to have fixed number of tweets with your timeline. Warning: this will remove the sidebar scroll possibility. Leave it blank if you use height option."> [?]</span></label>
       </td>
       <td>
		 <input  class="wdti_input" type="text" name="tweet_limit"  id="tweet_limit_for" size="40"  value="<?php echo $row->tweet_limit; ?>" onkeypress="return spider_check_isnum(event)"/>
       </td>
     </tr>
	 ...
	 <tr class="wdti_tr" id="theme">
	   <td class="wdti_td">
		 <label class="wdti_label">Theme: <span style="cursor:pointer;color:#3B5998"  class="wdti_tooltip" title="Embedded timelines are available in light and dark themes for customization. The light theme is for pages that use a white or light colored background, while the dark theme is for pages that use a black or dark color background."> [?]</span></label>
	   </td>
	   <td>
		 <input type="radio" class="wdti_checkbox" id="theme_1" value="light" name="theme" <?php if($row->theme=="light") echo 'checked="checked"';?> />
		 <label class="wdti_label_rad wdti_label_check" for="theme_1">Light</label>
		 <input type="radio" class="wdti_checkbox" id="theme_2"  value="dark" name="theme" <?php if($row->theme=="dark") echo 'checked="checked"';?>/>
		 <label class="wdti_label_rad wdti_label_check" for="theme_2">Dark</label>
       </td>
	 </tr>
	 <tr class="wdti_tr" id="link_color">
       <td class="wdti_td">
         <label class="wdti_label" for="link_color">Link Color: <span style="cursor:pointer;color:#3B5998" class="wdti_tooltip" title="You can choose custom link color for your timeline links to match your website color palette."> [?]</span></label>
       </td>
       <td>
         <input  class="color wdti_input_for_color"  type="text" name="link_color" size="40" value="<?php echo $row->link_color; ?>"/>
       </td>
     </tr>
     <tr class="wdti_tr" id="border">
       <td class="wdti_td">
         <label class="wdti_label" for="border">Border Color: <span style="cursor:pointer;color:#3B5998" class="wdti_tooltip"  title="You can change the border color used by the widget."> [?]</span></span></label>
       </td>
       <td>
         <input  class="color wdti_input_for_color" type="text" name="border" size="40" value="<?php echo $row->border; ?>"/>
       </td>
     </tr>
     <tr class="wdti_tr" id="chrome">
	   <td class="wdti_td">
		 <label class="wdti_label">Chrome:<span class="wdti_tooltip" style="cursor:pointer;color:#3B5998; position:relative;" 
title="
Use a space-separated set of the following options:					
...
Transparent: Removes the background color."> [?]</span>
		  </label>
	   </td>
	   <td>
		 <input  type="checkbox" class="wdti_checkbox"   value="noheader"  id="noheader" name="noheader" <?php if($row->noheader=="noheader") echo 'checked="checked"';?>  />
         <label class="wdti_label_rad wdti_label_check" for="noheader"> No Header</label>
         <input  type="checkbox" class="wdti_checkbox"  value="nofooter"  name="nofooter" id="nofooter"<?php if($row->nofooter=="nofooter") echo 'checked="checked"';?>  />
         <label class="wdti_label_rad wdti_label_check" for="nofooter"> No Footer</label>
         <input  type="checkbox" class="wdti_checkbox"  value="noborders"  name="noborders" id="noborders" <?php if($row->noborders=="noborders") echo 'checked="checked"';?>  /> 
	     <label class="wdti_label_rad wdti_label_check" for="noborders"> No Borders</label>
		 <input  type="checkbox" class="wdti_checkbox"  value="noscrollbar"  name="noscrollbar" id="noscrollbar" <?php if($row->noscrollbar=="noscrollbar") echo 'checked="checked"';?>  />
		 <label class="wdti_label_rad wdti_label_check" for="noscrollbar"> No Scrollbar</label>
         <input  type="checkbox" class="wdti_checkbox"  value="transparent"  name="transparent" id="transparent" <?php if($row->transparent=="transparent") echo 'checked="checked"';?>  />
		 <label class="wdti_label_rad wdti_label_check" for="transparent"> Transparent</label>							
	   </td>
	 </tr>
     <tr class="wdti_tr" id="aria_polite">
	   <td class="wdti_td">
		 <label class="wdti_label">ARIA politeness:<span style="cursor:pointer;color:#3B5998"  class="wdti_tooltip"  title="ARIA is an accessibility system that aids people using assistive technology interacting with dynamic web content. Read more about ARIA on W3C's website. By default, the embedded timeline uses the least obtrusive setting: 'polite'. If you're using an embedded timeline as a primary source of content on your page, you may wish to override this to the assertive setting, using 'assertive'."> [?]</span></label>
	   </td>
	   <td>
		 <input type="radio" class="wdti_checkbox" value="polite" name="aria_polite" id="aria_polite_1" <?php if($row->aria_polite=="polite") echo 'checked="checked"';?> />
		 <label class="wdti_label_rad wdti_label_check" for="aria_polite_1">Polite</label>
         <input type="radio" class="wdti_checkbox" value="assertive" name="aria_polite" id="aria_polite_2" <?php if($row->aria_polite=="assertive") echo 'checked="checked"';?>/>
	     <label class="wdti_label_rad wdti_label_check" for="aria_polite_2">Assertive</label>
	   </td>
	 </tr>
     <tr class="wdti_tr" id="show_replies">
	   <td class="wdti_td">
		 <label class="wdti_label">Show Replies:<span style="cursor:pointer;color:#3B5998"  class="wdti_tooltip"  title="You can choose  whether to show replies in the timeline or not."> [?]</span></label>
	   </td>
	   <td>
	     <input type="radio" class="wdti_checkbox" value="true" name="show_replies" id="show_replies_1" <?php if($row->show_replies=="true") echo 'checked="checked"';?> />
		 <label class="wdti_label_rad wdti_label_check" for="show_replies_1">Yes</label>
         <input type="radio" class="wdti_checkbox" value="false" name="show_replies" id="show_replies_2" <?php if($row->show_replies=="false") echo 'checked="checked"';?>/>
	     <label class="wdti_label_rad wdti_label_check" for="show_replies_2">No</label>
	   </td>
	 </tr>
