...
function spider_twitt_change_type (type) {
    ...
    switch (type) {
	    case 'tweetbutton':
			...
			document.getElementById('timeline_type').style.display='none';
			...
			document.getElementById('link_color').style.display='none';
			document.getElementById('chrome').style.display='none';
			document.getElementById('border').style.display='none';
			document.getElementById('tweet_limit').style.display='none';
			document.getElementById('aria_polite').style.display='none';
		...
		break;  
        case 'timeline': 
            document.getElementById('type').value='timeline';
            document.getElementById('counturl_tr').style.display='none';						
			document.getElementById('url_tr').style.display='none';				
			document.getElementById('show_count').style.display='none';
			document.getElementById('align').style.display='none';
			...
			if (jQuery("#pages_ids").val() == '')
            jQuery("#pages_div").hide();
			document.getElementById('timeline_type').style.display='';
			document.getElementById('width').style.display='';
			document.getElementById('tweet_to').style.display='none';
			document.getElementById('username_to_1').style.display='none';
			document.getElementById('username_to_2').style.display='none';
			...
			document.getElementById('tw_hashtag').style.display='none';	
			document.getElementById('text_tr').style.display='none';			
			document.getElementById('user_prev').style.display='none';
			document.getElementById('list_prev').style.display='none';
			document.getElementById('fav_prev').style.display='';
			document.getElementById('search_prev').style.display='none';			
			document.getElementById('url_type').style.display='none';			
			document.getElementById('theme').style.display='';
			document.getElementById('link_color').style.display='';
			document.getElementById('widget_id').style.display='';
			...
			document.getElementById('tweet_limit').style.display='';
			document.getElementById('aria_polite').style.display='';
		    ...
		    for(var i=1;i<=4;i++) {
				if(jQuery("#timeline_type_"+i).is(':checked')) {
				 var timeline_type = jQuery("#timeline_type_"+i).val();
				 break;
			    }
			}
